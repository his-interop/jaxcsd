...
import zw.co.hitrac.jaxcsd.api.domain.ext.FacilityExtension;
...
public class FacilityHandler {
    ...
    public static void handle(Facility facility, XMLStreamReader r) throws XMLStreamException {
        ...
        while (r.hasNext()) {
            ...
            if (r.isStartElement()) {
                if ("otherID".equals(r.getLocalName())) {
                    ...
                    FacilityExtension extension = new FacilityExtension();
                    facility.getExtensions().add(extension);
